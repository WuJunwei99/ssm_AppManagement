                      ...
                      <div id="step-2" style="height:320px">
                        <form class="form-horizontal form-label-left" id="schoolRoll">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="candidateNum" required="required" class="form-control ">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">学费<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 ">
                              <input class="form-control col" type="text" id="tuition">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input  class="form-control col" type="text" id="hotelExpense">
                            </div>
                          </div>
                        </form>
                      </div>
                      <div id="step-3">
                        <form class="form-horizontal form-label-left" id="contactsInfo">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="phone1" class="form-control col" type="text" name="phone1">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="workAddress1" class="form-control col" type="text" name="workAddress1">
                            </div>
                          </div>
                          <div class="clearfix"></div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">电话<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="phone2" class="form-control col" type="text" name="phone2">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">工作地址<span class="required">*</span>
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="workAddress2" class="form-control col" type="text" name="workAddress2">
                            </div>
                          </div>
                        </form>
                      </div>
                      <div id="step-4">
                        <form class="form-horizontal form-label-left" id="contractInfo">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="lender" class="form-control col" type="text" name="lender">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="branchLender" name="branchLender" required="required" class="form-control ">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">经办人</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="agent" class="form-control col" type="text" name="agent">
                            </div>
                          </div>
                          <div class="form-group row">
...
function getProvince() {
	$.ajax( {
      ...
      for(var i=0;i<data.rows.length;i++){
        ...
        var html = "<option id='" + entry.provinceID 
 ...
 function getContract(){		
        $.ajax({
          ...
          success:function(data){			
            ...
            hotelExpense= student.hotelExpense;
            sex= student.sex;
            ...
            document.getElementById("candidateNum").value = candidateNum;
            ...
            document.getElementById("branchLender").value = branchLender;
            document.getElementById("agent").value = agent;
            document.getElementById("approveDate").value = approveDate;
            document.getElementById("beginDate").value = beginDate;
            document.getElementById("endDate").value = endDate;
              getProvince();
              getDepartment();
			      	setTimeout(function(){
                $("#"+provinceId).prop("selected",true);
                $("#contractBankType"+contractBankType).prop("checked",true);
                $("#departmentId"+clazz.departmentId).prop("selected",true);
                getCity();
                getMajor();
                            //合同信息
            if(contractBankType=="0"){
              ...
              setTimeout(function(){
                  ...
                  $("#majorId"+clazz.majorId).prop("selected",true);
                  getArea();
                  getClazz();
                },200);
              setTimeout(function(){
...
function getCity() {
	...
	if (object.val() != 0) {
        ...
        for(var i=0;i<data.rows.length;i++){
          var entry=data['rows'][i];
          var html = "<option id='" + entry.cityID 
						+ "'value='" + entry.cityID + "''>"
						+ entry.city + "</option>";
            $("#selcity").append(html);
      }
...
function getArea() {
	...
	if (object.val() != 0) {
        ...
        for(var i=0;i<data.rows.length;i++){
          var entry=data['rows'][i];
          var html = "<option id='" + entry.areaId
						+ "'value='" + entry.areaId + "''>"
						+ entry.area + "</option>";
            $("#selarea").append(html);
      }
...
function getDepartment() {
	$.ajax( {
      ...
      for(var i=0;i<data.rows.length;i++){
        var entry=data['rows'][i];
        var html = "<option id='departmentId" + entry.departmentId 
...
function getMajor() {
	...
	if (object.val() != 0) {
        ...
        for(var i=0;i<data.rows.length;i++){
          var entry=data['rows'][i];
          var html = "<option id='majorId" + entry.majorId 
						+ "'value='" + entry.majorId + "''>"
...
function getClazz() {
	...
	if (object.val() != 0) {
        ...
        for(var i=0;i<data.rows.length;i++){
          var entry=data['rows'][i];
					var html = "<option id='classId" + entry.classId +"'value=" + entry.classId + "'>"
