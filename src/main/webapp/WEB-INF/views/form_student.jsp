                      ...
                      <div id="step-1">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">学号<span class="required">*</span>
                            </label>
                          ...
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">身份证</label>
                            <div class="col-md-6 col-sm-6 ">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <div id="gender" class="btn-group" data-toggle="buttons">
                                ...
                                <p>
                                  男
                                  <input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required /> 女
